from medvae.utils.factory import create_model_and_transform, create_model_and_transform_offline
...
class MVAE(torch.nn.Module):
    def __init__(self, model_name: str, modality: str, gpu_dim=160, model_weights_dir=None):
        ...
        if model_weights_dir is None:
            ...
            self.model, self.transform = create_model_and_transform_offline(
                self.model_name, self.modality, model_weights_dir
            )
